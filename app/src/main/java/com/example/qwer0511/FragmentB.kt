...
class FragmentB : Fragment() {
    ...
    private var mSendButton2: Button? = null
    private var mSendButton3: Button? = null

    private var mSendButton13: Button? = null
    private var mSendButton14: Button? = null
    private var mSendButton15: Button? = null
    private var mSendButton16: Button? = null
    private var mSendButton17: Button? = null
    private var mSendButton18: Button? = null

    private var mSendButton42: Button? = null
    private var mSendButton43: Button? = null
    private var mSendButton44: Button? = null
    private var mSendButton45: Button? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mSendButton2 = view.findViewById(R.id.button2)
        mSendButton3 = view.findViewById(R.id.button3)

        mSendButton13 = view.findViewById(R.id.button13)
        mSendButton14 = view.findViewById(R.id.button14)
        mSendButton15 = view.findViewById(R.id.button15)
        mSendButton16 = view.findViewById(R.id.button16)
        mSendButton17 = view.findViewById(R.id.button17)
        mSendButton18 = view.findViewById(R.id.button18)

        mSendButton42 = view.findViewById(R.id.button42)
        mSendButton43 = view.findViewById(R.id.button43)
        mSendButton44 = view.findViewById(R.id.button44)
        mSendButton45 = view.findViewById(R.id.button45)
    ...
    private fun setupChat() {
        ...
        mSendButton2!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton3!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton13!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton14!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton15!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton16!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton17!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton18!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton42!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton43!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton44!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton45!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
