...
class FragmentD : Fragment() {
    ...
    private var mSendButton28: Button? = null
    private var mSendButton29: Button? = null
    private var mSendButton30: Button? = null

    private var mSendButton35: Button? = null
    private var mSendButton36: Button? = null
    private var mSendButton37: Button? = null

    private var mSendButton32: Button? = null
    private var mSendButton33: Button? = null
    private var mSendButton34: Button? = null
    private var mSendButton31: Button? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        mSendButton28 = view.findViewById(R.id.button28)
        mSendButton29 = view.findViewById(R.id.button29)
        mSendButton30 = view.findViewById(R.id.button30)

        mSendButton35 = view.findViewById(R.id.button35)
        mSendButton36 = view.findViewById(R.id.button36)
        mSendButton37 = view.findViewById(R.id.button37)

        mSendButton32 = view.findViewById(R.id.button32)
        mSendButton33 = view.findViewById(R.id.button33)
        mSendButton34 = view.findViewById(R.id.button34)

        mSendButton31 = view.findViewById(R.id.button31)
    ...
    private fun setupChat() {
        ...
        mSendButton28!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
        ...
        mSendButton29!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton30!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton35!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton36!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton37!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton32!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton33!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton34!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
        ...
        mSendButton31!!.setOnClickListener { // Send a message using content of the edit text widget
            val view = view
            if (null != view) {
                //val textView = view.findViewById<TextView>(R.id.edit_text_out)
                //val message = textView.text.toString()
